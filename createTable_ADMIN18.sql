...
CREATE VIEW VUE_EVENTS 
	AS SELECT idEvent,idUser,dateEvent,placeEvent,nameEvent,typeEvent,canceled 
	FROM EVENTS;
...
INSERT INTO EVENTS VALUES('EVENT1','USER2','12/10/2019','PARIS','Soliday','Festif',24000,4,10,'Festival de musique',0);
INSERT INTO EVENTS VALUES('EVENT2','USER2','23/10/2019','PARIS','Activiste','Culturel',240000,6,31,'Festival polyculturel',0);
INSERT INTO EVENTS VALUES('EVENT3','USER3','15/10/2019','PARIS','CEO','Culturel',560000,23,54,'Festival de veille technologique',0);
