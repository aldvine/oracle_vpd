...
/** USER1 **/
INSERT INTO USER VALUES('USER2','E658790V','organizer2','organizer2','Lyon','2222222222');
INSERT INTO USER VALUES('USER3','E348715H','organizer3','organizer3','Paris','3333333333');
INSERT INTO USER VALUES('USER4','E238150J','participate4','participate4','Nantes','4444444444');
INSERT INTO USER VALUES('USER5','E729478S','participate5','participate5','Nantes','5555555555');
INSERT INTO USER VALUES('USER6','E452394P','participate6','participate6','Paris','6666666666');
INSERT INTO USER VALUES('USER7','E347987R','collectivity7','collectivity7','Lyon','7777777777');
DELETE EVENT WHERE idUser = 'USER3';
UPDATE FROM USER SET phone = '2345678901' WHERE idUser = 'USER3';

/** USER2 **/
SELECT * FROM USER;
UPDATE USER SET address = 'Nantes';
SELECT * FROM USER;
INSERT INTO EVENT VALUES('EVENT1','USER2','31/10/2019','NANTES','OctoberFest','Festif',120000,2,4,'Fête nantaise');
INSERT INTO EVENT VALUES('EVENT2','USER2','31/11/2019','LYON','DevFest','Culturel',40000,1,6,'Découverte des technologies');
UPDATE EVENT SET dateEvent = '22/10/2019' WHERE idEvent = 'EVENT1';
SELECT * FROM EVENT;
DELETE FROM EVENT WHERE idEvent = 'EVENT1';
SELECT * FROM EVENT;
SELECT * FROM PARTICPATE;

/** USER3 **/
INSERT INTO EVENT VALUES('EVENT3','USER3','12/10/2019','PARIS','Soliday','Festif',24000,4,10,'Festival de musique');
INSERT INTO EVENT VALUES('EVENT4','USER3','23/10/2019','PARIS','Activiste','Culturel',240000,6,31,'Festival polyculturel');
INSERT INTO EVENT VALUES('EVENT5','USER3','15/10/2019','PARIS','CEO','Culturel',560000,23,54,'Festival de veille technologique');
INSERT INTO EVENT VALUES('EVENT6','USER3','25/10/2019','MARSEILLE','Tournoi de pétanque','Culturel/Sportif',50000,0,6,'Concour de pétanque');
INSERT INTO EVENT VALUES('EVENT7','USER3','04/11/2019','NANTES','Festival des plantes','Culturel/Exposition',6000,1,12,'Exposition de plante');
UPDATE EVENT SET dateEvent = '24/11/2019' WHERE idEvent = 'EVENT3';
SELECT * FROM EVENT;
DELETE FROM EVENT WHERE idEvent = 'EVENT2';
SELECT * FROM EVENT;
SELECT * FROM PARTICPATE;

/** USER4 **/
SELECT * FROM USER;
UPDATE USER SET phone = '0909090909';
SELECT * FROM USER;
SELECT * FROM VUE_EVENT;
INSERT INTO PARTICIPATE VALUES('EVENT2','USER4','07/10/2019');
INSERT INTO PARTICIPATE VALUES('EVENT3','USER4','07/10/2019');
SELECT * FROM PARTICIPATE;
DELETE FROM PARTICIPATE WHERE idEvent = 'EVENT2';
SELECT * FROM PARTICPATE;

/** USER5 **/
SELECT * FROM USER;
UPDATE USER SET phone = '0674355687';
SELECT * FROM USER;
SELECT * FROM VUE_EVENT;
INSERT INTO PARTICIPATE VALUES('EVENT4','USER5','07/10/2019');
INSERT INTO PARTICIPATE VALUES('EVENT3','USER5','07/10/2019');
SELECT * FROM PARTICIPATE;
DELETE FROM PARTICIPATE WHERE idEvent = 'EVENT4';
SELECT * FROM PARTICPATE;
...
SELECT * FROM USER;
SELECT * FROM VUE_EVENT;
INSERT INTO PARTICIPATE VALUES('EVENT5','USER6','07/10/2019');
INSERT INTO PARTICIPATE VALUES('EVENT4','USER6','07/10/2019');
INSERT INTO PARTICIPATE VALUES('EVENT3','USER6','07/10/2019');
SELECT * FROM PARTICIPATE;
DELETE FROM PARTICIPATE WHERE idEvent = 'EVENT4';
SELECT * FROM PARTICPATE;
