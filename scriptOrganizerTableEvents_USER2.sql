...
INSERT INTO ADMIN18.EVENTS VALUES('EVENT1','USER2','31/10/2019','NANTES','OctoberFest','Festif',120000,2,4,'Fête nantaise',0);
INSERT INTO ADMIN18.EVENTS VALUES('EVENT2','USER2','31/11/2019','LYON','DevFest','Culturel',40000,1,6,'Découverte des technologies',0);
COMMIT;
...
UPDATE ADMIN18.EVENTS SET canceled = 1 WHERE idEvent = 'EVENT1';
COMMIT;
